import { JSBI, Price, Token } from '@1ech/sdk'
...
const ONE_USDS_PER_CAKE = new Price(RECH, USDS, EIGHTEEN_DECIMALS, ONE)
const FIVE_USDS_PER_CAKE = new Price(RECH, USDS, EIGHTEEN_DECIMALS, FIVE)
const SEVEN_USDS_PER_CAKE = new Price(RECH, USDS, EIGHTEEN_DECIMALS, SEVEN)
const ELEVEN_USDS_PER_CAKE = new Price(RECH, USDS, EIGHTEEN_DECIMALS, ELEVEN)
const SEVEN_HUNDRED_USDS_PER_CAKE = new Price(RECH, USDS, EIGHTEEN_DECIMALS, SEVEN_HUNDRED)
...
describe('limitOrders/utils/getRatePercentageMessage', () => {
  describe.each([
    [
      getRatePercentageDifference(SEVEN_USDS_PER_CAKE, ELEVEN_USDS_PER_CAKE),
      ['57.14% above market', PercentageDirection.ABOVE],
    ],
    [
      getRatePercentageDifference(SEVEN_USDS_PER_CAKE, FIVE_USDS_PER_CAKE),
      ['-28.57% below market', PercentageDirection.BELOW],
    ],
    [
      getRatePercentageDifference(SEVEN_USDS_PER_CAKE, SEVEN_HUNDRED_USDS_PER_CAKE),
      ['9,900% above market', PercentageDirection.ABOVE],
    ],
    [
      getRatePercentageDifference(SEVEN_USDS_PER_CAKE, ONE_USDS_PER_CAKE),
      ['-85.71% below market', PercentageDirection.BELOW],
    ],
    [
      getRatePercentageDifference(SEVEN_USDS_PER_CAKE, SEVEN_USDS_PER_CAKE),
