...
describe('limitOrders/utils/getPriceForOneToken', () => {
  describe.each([
    [new TokenAmount(RECH, ONE), new TokenAmount(BUSD, ONE), '1'],
    [new TokenAmount(RECH, FIVE), new TokenAmount(BUSD, FIVE), '1'],
    [new TokenAmount(RECH, ONE), new TokenAmount(BUSD, FIVE), '5'],
    [new TokenAmount(RECH, FIVE), new TokenAmount(BUSD, ONE), '0.2'],
    ...
    [new TokenAmount(RECH, ZERO), new TokenAmount(BUSD, ONE), undefined],
    [new TokenAmount(RECH, ONE), new TokenAmount(BUSD, ZERO), undefined],
