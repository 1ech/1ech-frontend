...
interface EchWechNoticeProps {
  isDark: boolean
  isChartExpanded: boolean
}

const EchWechNotice: React.FC<EchWechNoticeProps> = ({ isDark, isChartExpanded }) => {
    ...
    <StyledPriceChart $isDark={isDark} $isExpanded={isChartExpanded} p="24px">
      <Flex justifyContent="center" alignItems="center" height="100%" flexDirection="column">
        <Text mb={['8px', '8px', '0px']} textAlign="center">
          {t('You can swap WECH for ECH (and vice versa) with no trading fees.')}
        </Text>
        <Text mb={['8px', '8px', '0px']} textAlign="center">
