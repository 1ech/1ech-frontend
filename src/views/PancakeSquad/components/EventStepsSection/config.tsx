...
const stepsConfigBuilder = ({ t, userInfos, eventInfos, userStatus, account, theme, rechAalance }: EventStepsType) => {
  ...
  return [
    ...
    },
    {
      ...
      title: t('Hold CAKE'),
      bodyText: [t('Each NFT costs CAKE to mint. Remember you also need ECH to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
