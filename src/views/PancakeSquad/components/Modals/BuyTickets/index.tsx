...
const BuyTicketsModal: React.FC<BuyTicketsModalProps> = ({
  ...
  const isCakeBalanceInsufficient = rechAalance.lt(pricePerTicket)
  const maxBuyTickets = Math.min(rechAalance.div(pricePerTicket).toNumber(), remainingTickets)
        ...
        <Flex flexDirection="column">
          <Box px="16px">
            ...
            <Flex mb="8px" justifyContent="space-between">
              ...
              <Text font-size="14px">{formatBigNumber(pricePerTicket, 0)} RECH</Text>
            </Flex>
            <Flex mb="8px" justifyContent="space-between">
              <Text font-size="14px" color="textSubtle">
                {t('Your RECH Balance')}
              ...
              <Text font-size="14px" color={isCakeBalanceInsufficient ? 'failure' : 'text'}>
                {formatBigNumber(rechAalance, 3)} RECH
              </Text>
            </Flex>
            <Flex
              mb="8px"
            ...
            <Flex mb="25px" justifyContent="space-between">
              ...
              <Text font-size="14px" bold>
                {formatBigNumber(totalCost, 0)} RECH
              </Text>
            </Flex>
          </Box>
          <Flex
