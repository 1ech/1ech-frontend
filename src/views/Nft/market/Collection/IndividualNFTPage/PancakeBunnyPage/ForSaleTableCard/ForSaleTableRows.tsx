...
const Row: React.FC<RowProps> = ({ t, nft, echUsdsPrice, account, onSuccessSale }) => {
  const priceInUsd = multiplyPriceByAmount(echUsdsPrice, parseFloat(nft?.marketData?.currentAskPrice))
