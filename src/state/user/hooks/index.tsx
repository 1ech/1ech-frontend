import { ChainId, Pair, Token } from '@1ech/sdk'
 ...
 */
/* dust: note the term 'Cake-LP' is specific to Pancake Protocol.  an update to SDK, Router, Factory, .. is required to change it */
