import { CurrencyAmount, JSBI } from '@1ech/sdk'
...
describe('maxAmountSpend', () => {
  ...
  it('should has value when CurrencyAmount is ECH and CurrencyAmount is higher than min ech', () => {
    expect(
      JSBI.greaterThan(
  ...
  it('should be 0 when CurrencyAmount is ECH and CurrencyAmount is low', () => {
